...
public final class CrawljaxConfiguration {
	...
	public void alsoCrawl(String url){
		try {
			this.crawlSpecification.addUrlToList(new URL(url));
			System.out.println("URL gets added to the URL list.");
			System.out.println("Number of url in list now is " + this.crawlSpecification.getUrlArraySize());
