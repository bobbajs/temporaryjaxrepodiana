...
public class CrawlSpecification {
	...
	private int lastURLCrawledIndex = 0; 
	...
	/**
	 * Diana's changes -- don't forget to change this later
	 * @return the next url of the site that we have to crawl.
	 * return NULL if we reach the end of arrayList.
	 */
	protected URL getNextURL(){
		return this.urls.get(this.lastURLCrawledIndex);
	}
	
	protected void updateUrlArrayIndex(){
		this.lastURLCrawledIndex++;
	}
	
	protected int getLastURLCrawledIndex(){
		return this.lastURLCrawledIndex;
	}
	
	public void addUrlToList(URL newUrl){
